...
import "./NeutronChainCoin.sol";

contract NeutronChainCoinPreSale {
    NeutronChainCoin public token;
    ...
    function NeutronChainCoinPreSale(
        NeutronChainCoin _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = NeutronChainCoin(_token);
